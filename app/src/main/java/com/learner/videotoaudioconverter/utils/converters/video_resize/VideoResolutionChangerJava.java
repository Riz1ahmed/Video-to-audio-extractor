...
@TargetApi(18)
public class VideoResolutionChangerJava {
    ...
    private static class ChangerWrapper implements Runnable {
        ...
        private VideoResolutionChangerJava mChanger;

        private ChangerWrapper(VideoResolutionChangerJava changer) {
            mChanger = changer;
        }
        ...
        public static void changeResolutionInSeparatedThread(VideoResolutionChangerJava changer)
                throws Throwable {
